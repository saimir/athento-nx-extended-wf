                  ...
                  <tbody>
                    ...
                    <tr>
                      <td style="background-color:#fff;padding:8px 20px;"><br/>
                        ...
                        Un usuario ha revisado el documento: <a style="color:#22aee8;text-decoration:underline;word-wrap:break-word !important;" href="${docUrl}">${docTitle}</a>, y usted ha sido notificado tras el cambio</strong>.
                        </p>
                        <br/>
